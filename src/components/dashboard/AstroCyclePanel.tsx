...
const planetPositions: PlanetPosition[] = [
  ...
  { name: "Mercury", sign: "Leo", degree: 146.86, retrograde: true },
  { name: "Venus", sign: "Aries", degree: 25.05 },
  { name: "Mars", sign: "Aquarius", degree: 316.78 },
  { name: "Jupiter", sign: "Libra", degree: 187.54 },
  { name: "Saturn", sign: "Virgo", degree: 157.13 },
  { name: "Uranus", sign: "Leo", degree: 126.18 },
  { name: "Neptune", sign: "Aries", degree: 26.70 },
];

const planetaryAspects: PlanetaryAspect[] = [
  { planet1: "Sun", planet2: "Mercury", aspect: "Trine", type: "Harmonious", degree: 114.9, orb: 5.1 },
  { planet1: "Sun", planet2: "Venus", aspect: "Trine", type: "Harmonious", degree: 123.3, orb: 3.3 },
  { planet1: "Sun", planet2: "Mars", aspect: "Sextile", type: "Positive", degree: 55.0, orb: 5.0 },
  { planet1: "Sun", planet2: "Neptune", aspect: "Trine", type: "Harmonious", degree: 124.9, orb: 4.9 },
  { planet1: "Moon", planet2: "Jupiter", aspect: "Square", type: "Challenging", degree: 84.4, orb: 5.6 },
  { planet1: "Moon", planet2: "Saturn", aspect: "Sextile", type: "Positive", degree: 54.0, orb: 6.0 },
  { planet1: "Mercury", planet2: "Venus", aspect: "Trine", type: "Harmonious", degree: 121.8, orb: 1.8 },
  { planet1: "Mercury", planet2: "Neptune", aspect: "Trine", type: "Harmonious", degree: 120.2, orb: 0.2 },
];
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2 max-h-[320px] overflow-y-auto pr-1">
            {planetPositions.map((planet) => (
              <div key={planet.name} className="flex items-center justify-between p-2 bg-secondary/50 rounded-lg">
