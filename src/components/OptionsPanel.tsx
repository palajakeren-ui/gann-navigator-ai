...
export const OptionsPanel = ({
  ...
  return (
    <Card className={`p-6 border-2 ${isBullish ? "border-bullish bg-bullish/5" : "border-bearish bg-bearish/5"}`}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="p-3 bg-secondary/30 rounded">
          ...
          <Badge className={isBullish ? "bg-bullish text-white" : "bg-bearish text-white"}>
            {bias} (bullish)
          </Badge>
        </div>
