        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-2xl font-bold text-success">BUY SIGNAL</h3>
                <p className="text-sm text-muted-foreground">Strength: 0.91 • Confidence: 82%</p>
              </div>
            </div>
        ...
        <TabsContent value="ehlers" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <Badge variant="outline" className="w-fit text-success border-success">
                Composite Score: 0.88 (Bullish)
              </Badge>
            </CardHeader>
            <CardContent>
              <Table>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Daily Short-Term Forecast (7 Days)
              </CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
